...
#from TESTS.OBJECTIVES2_TEST01_1DMG_CSTest03 import *
#from TESTS.OBJECTIVES2_TEST02_2DMG_C3_VandV import *
#from TESTS.OBJECTIVES2_TEST03_2DMG_BIBLIS_VandV import *
#from TESTS.OBJECTIVES2_TEST04_2DTriMG_HOMOG_VandV import *
#from TESTS.OBJECTIVES2_TEST05_2DTriMG_VVER400_VandV import *
#from TESTS.OBJECTIVES2_TEST06_3DMG_CSTest09_VandV_new import *
#from TESTS.OBJECTIVES2_TEST07_3DTriMG_VVER400_VandV import *
#from TESTS.OBJECTIVES2_TEST08_2DTriMG_HTTR2G_VandV import *
#from TESTS.OBJECTIVES2_TEST09_3DTriMG_HTTR import *
#from TESTS.OBJECTIVES2_TEST10_3DMG_Langenbuch import *
...
def main():
    ...
    if geom_type =='1D':
        ...
        plt.xscale('log')
        plt.xlabel('Frequency (Hz)')
        plt.ylabel('Difference of Magnitude of Neutron Noise (%)')
        ...
        plt.xscale('log')
        plt.xlabel('Frequency (Hz)')
        plt.ylabel('Difference of Phase of Neutron Noise (%)')
